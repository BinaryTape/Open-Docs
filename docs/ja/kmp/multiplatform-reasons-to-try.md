...
[![Kotlin Multiplatform の実際のユースケースを探索する](kmp-use-cases-1.svg){width="500"}](https://www.jetbrains.com/help/kotlin-multiplatform-dev/case-studies.html)
...
![Kotlin Multiplatform を始める](get-started-with-kmp.svg){width="500"}
