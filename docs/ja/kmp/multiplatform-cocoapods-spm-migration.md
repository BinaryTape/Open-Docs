...
> [用意されているスキル](https://github.com/Kotlin/kotlin-agent-skills/tree/main/skills/kotlin-tooling-cocoapods-spm-migration)を使用して、CocoaPods から SwiftPM への移行をお好みの AI エージェントに任せることができます。
