...
* サンプルプロジェクトは [GitHubリポジトリ](https://github.com/Kotlin/kmp-with-cocoapods-multitarget-xcode-sample) で確認できます。
...
> * Kotlin/Nativeモジュールに依存関係を正しくインポートするには、Podfileに [`use_modular_headers!`](https://guides.cocoapods.org/syntax/podfile.html#use_modular_headers_bang) または [`use_frameworks!`](https://guides.cocoapods.org/syntax/podfile.html#use_frameworks_bang) ディレクティブが含まれている必要があります。
...
2. Xcodeで、アプリケーションターゲットの **Build Options** にある **User Script Sandboxing** を無効にしてください。
   ...
   ![CocoaPodsのサンドボックス化を無効にする](disable-sandboxing-cocoapods.png)
...
5. 各ターゲットに対して、Podライブラリの最小デプロイターゲットのバージョンを指定します。
...
* [CocoaPods GradleプラグインのDSLリファレンス全文を確認する](multiplatform-cocoapods-dsl-reference.md)