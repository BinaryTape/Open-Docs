...
3. **desktopApp [hot] 🔥** 実行構成を開始して、[Compose ホットリロード](compose-hot-reload.md) を使用してデスクトップでアプリケーションを実行します。
   アプリは動作しますが、ウィンドウが UI に対して明らかに不釣り合いに見えます。
...
6. アプリが自動的に更新されるのを確認するには、変更したファイルを保存します（<shortcut>⌘ S</shortcut> / <shortcut>Ctrl+S</shortcut>）。見た目が改善されるはずです。
   ...
   ![デスクトップ上の Compose Multiplatform アプリの小さいウィンドウ](first-compose-project-on-desktop-4.png){width=350}

   ![Compose ホットリロード](compose-hot-reload-resize.gif)

## ユーザー入力をサポートする {id="support-user-input"}
...
<Tabs>
    ...
    <TabItem id="web-user-input" title="Web">
        <img src="first-compose-project-on-web-3.png" alt="Web の Compose Multiplatform アプリでのユーザー入力" width="500"/>
    </TabItem>
</Tabs>

## 時刻を計算する {id="calculate-time"}
...
1. `composeApp/src/commonMain/kotlin/compose.project.demo/App.kt` ファイルに戻り、以下の関数を追加します。
   ...
   fun currentTimeAt(location: String): String? {
    ...
    > [kotlinx-datetime](https://github.com/Kotlin/kotlinx-datetime) ライブラリがまだプロジェクトに追加されていない場合は、[新しい依存関係を追加する](compose-multiplatform-modify-project.md#add-a-new-dependency) セクションの指示に従ってください。
    >
    {style="note"}
...
<Tabs>
    ...
    <TabItem id="web-time-display" title="Web">
        <img src="first-compose-project-on-web-4.png" alt="Web の Compose Multiplatform アプリでの時刻表示" width="500"/>
    </TabItem>
</Tabs>

## スタイルを改善する {id="improve-the-style"}
...
<Tabs>
    ...
    <TabItem id="web-improved-style" title="Web">
        <img src="first-compose-project-on-web-5.png" alt="Web の Compose Multiplatform アプリの改善されたスタイル" width="500"/>
    </TabItem>
</Tabs>

## デザインをリファクタリングする {id="refactor-the-ui"}
...
<Tabs>
   ...
   <TabItem id="web-country-list" title="Web">
        <img src="first-compose-project-on-web-6.png" alt="Web の Compose Multiplatform アプリでの国リスト" width="500"/>
    </TabItem>
</Tabs>
...
<Tabs>
   ...
   <TabItem id="web-flags" title="Web">
        <img src="first-compose-project-on-web-7.png" alt="Web の Compose Multiplatform アプリでの国旗" width="500"/>
    </TabItem>
</Tabs>
