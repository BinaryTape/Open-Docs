...
Navigation 3 のマルチプラットフォームの例では、ポリモーフィックなシリアル化は[以下のようになります](https://github.com/terrakok/nav3-recipes/blob/8ff455499877225b638d5fcd82b232834f819422/sharedUI/src/commonMain/kotlin/com/example/nav3recipes/basicdsl/BasicDslActivity.kt#L40):
