[//]: # (title: Compose Multiplatform 1.11.0-beta02 の新機能)
...
変更点の完全なリストは [GitHub](https://github.com/JetBrains/compose-multiplatform/releases/tag/v1.11.0-beta02) で確認できます。
