...
![Kotlin Multiplatformユーザーがプラットフォーム間で共有できるコードの部品](survey-results-q1-q2-22.png){width=700}
...
> [グローバル企業やスタートアップのKotlin Multiplatformケーススタディ](https://kotlinlang.org/case-studies/?type=multiplatform)をすべて確認する。
>
{style="note"}
