...
### Kotlin Multiplatform とは何ですか？ {id="what-is-kotlin-multiplatform"}
...
### Kotlin Multiplatform で UI コードを共有できますか？ {id="can-i-share-ui-code-using-kotlin-multiplatform"}
...
### Kotlin Multiplatform プロジェクトを新規作成するにはどうすればよいですか？ {id="how-do-i-create-a-new-kotlin-multiplatform-project"}
...
### 実際に試せる完全なサンプルはどこにありますか？ {id="where-can-i-get-complete-examples-to-play-with"}

[実用的な例のリスト](multiplatform-samples.md)はこちらにあります。

### 実際の Kotlin Multiplatform アプリケーションのリストはどこにありますか？ また、どの企業が本番環境で KMP を使用していますか？ {id="where-can-i-find-a-list-of-real-life-kotlin-multiplatform-applications-what-companies-use-kmp-in-production"}
...
### Kotlin/Native とは何ですか？ Kotlin Multiplatform とはどのような関係がありますか？ {id="what-is-kotlin-native-and-how-does-it-relate-to-kotlin-multiplatform"}
...
### Compose Multiplatform とは何ですか？ {id="what-is-compose-multiplatform"}
...
### Android 用の Jetpack Compose とはどのような関係がありますか？ {id="how-does-it-relate-to-jetpack-compose-for-android"}
...
### Compose Multiplatform プロジェクトを新規作成するにはどうすればよいですか？ {id="how-do-i-create-a-new-compose-multiplatform-project"}
...
### Compose Multiplatform を使用したアプリ構築にはどの IDE を使用すべきですか？ {id="what-ide-should-i-use-for-building-apps-with-compose-multiplatform"}
...
### デモアプリケーションで試すことはできますか？ どこにありますか？ {id="can-i-play-with-a-demo-application-where-can-i-find-it"}
...
### Jetpack Compose を使用している既存の Android アプリケーションがあります。他のプラットフォームに移行するには何をすべきですか？ {id="i-have-an-existing-android-application-that-uses-jetpack-compose-what-should-i-do-to-migrate-it-to-other-platforms"}
...
### UIKit や SwiftUI コンポーネントを Compose 画面に統合できますか？ {id="can-i-integrate-uikit-or-swiftui-components-into-a-compose-screen"}

はい、可能です。[SwiftUI との統合](compose-swiftui-integration.md) および [UIKit との統合](compose-uikit-integration.md) を参照してください。

<!-- Need to revise
### モバイル OS がアップデートされ、新しいプラットフォーム機能が導入された場合はどうなりますか？ {id="what-happens-when-my-mobile-os-updates-and-introduces-new-platform-capabilities"}
...
### モバイル OS のアップデートにより、システムコンポーネントの視覚的スタイルや動作が変更された場合はどうなりますか？ {id="what-happens-when-my-mobile-os-updates-and-changes-the-visual-style-of-the-system-components-or-their-behavior"}
...
### Kotlin Multiplatform の進化に関する計画を教えてください。 {id="what-are-the-plans-for-the-kotlin-multiplatform-evolution"}
...
### Compose Multiplatform はいつ安定版になりますか？ {id="when-will-compose-multiplatform-become-stable"}
...
### Kotlin および Compose Multiplatform におけるウェブターゲットの今後のサポートはどうなりますか？ {id="what-about-future-support-for-web-targets-in-kotlin-and-compose-multiplatform"}
...
### マルチプラットフォーム開発用のツールを改善する計画はありますか？ {id="are-there-any-plans-to-improve-tooling-for-multiplatform-development"}

はい、私たちはマルチプラットフォームツールの現在の課題を痛感しており、いくつかの分野で積極的に強化に取り組んでいます。

### Swift との相互運用性（interoperability）を提供する予定はありますか？ {id="are-you-going-to-provide-swift-interoperability"}
