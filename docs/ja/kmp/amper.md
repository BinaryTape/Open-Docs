...
* [JetBrains ブログ](https://blog.jetbrains.com/blog/2023/11/09/amper-improving-the-build-tooling-user-experience) をチェックして、Amper を作成した背景にある動機、ユースケース、プロジェクトの現状、および将来について詳しく学んでください。
