...
### [KSP アノテーションのセットアップ](/docs/setup/annotations-ksp) (非推奨)

KSP ベースのアノテーション向けのレガシーなセットアップ：
- ⚠️ 非推奨 - コンパイラプラグインへ移行してください
- 移行ガイドが含まれています

## バージョンの互換性

| Koin バージョン | Kotlin バージョン | コンパイラプラグイン |
|--------------|----------------|-----------------|
| 4.2.x | 2.3+ | ✅ 推奨 |
| 4.1.x | 2.1/2.2+ | ⚠️ KSP のみ |
| 4.0.x | 1.9/2.0+ | ⚠️ KSP のみ |
| 3.5.x | 1.8+ | ❌ 利用不可 |
