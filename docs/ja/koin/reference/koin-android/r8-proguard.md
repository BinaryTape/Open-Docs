...
## Koin が自動で保持するもの（同梱のコンシューマー・ルール） {id="what-koin-keeps-for-you-shipped-consumer-rules"}
...
## ユーザーが保持する必要があるもの {id="what-you-must-keep"}
...
## ViewModels と SavedStateHandle (#2044) {id="viewmodels-savedstatehandle-2044"}
...
## Android 以外のターゲット (JS / WASM / Native) {id="non-android-targets-js-wasm-native"}
