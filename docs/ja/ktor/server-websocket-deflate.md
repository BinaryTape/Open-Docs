...
### 高度な設定パラメータ {id="advanced-configuration-parameters"}

#### コンテキストのテイクオーバー（Context takeover） {id="context-takeover"}
...
#### 圧縮条件の指定 {id="specify-compress-condition"}
...
#### プロトコルリストの微調整 {id="fine-tune-list-of-protocols"}
