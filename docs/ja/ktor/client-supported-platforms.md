...
マルチプラットフォームモバイルアプリケーションでも、フルスタックWebアプリケーションでも、[マルチプラットフォームプロジェクト](https://kotlinlang.org/docs/multiplatform.html)で使用できます。マルチプラットフォームプロジェクトでは、以下の[ターゲット](https://kotlinlang.org/docs/multiplatform-dsl-reference.html#targets)がサポートされています。
