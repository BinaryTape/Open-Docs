...
## デフォルトのプロジェクト構造 {id="default-project-structure"}
...
### アプリケーションおよびルーティングレイヤー {id="application-and-routing-layer"}
...
### モジュリス（Modulith）デプロイ {id="modulith-deployment"}
