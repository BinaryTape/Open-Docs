...
## インスタンスの作成 {id="creating-instances"}
...
## コンストラクタと初期化ブロック {id="constructors-and-initializer-blocks"}
...
### プライマリコンストラクタ {id="primary-constructor"}
...
### セカンダリコンストラクタ {id="secondary-constructors"}
...
### コンストラクタのないクラス {id="classes-without-constructors"}
