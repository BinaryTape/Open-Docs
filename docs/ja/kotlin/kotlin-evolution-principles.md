...
[Kotlinのリリースプロセス](releases.md)で説明されているように、言語機能は *言語リリース*（2.*x*.*0*）またはそれに続く *ツールリリース*（2.*x*.*20*）で提供されます。
...
すべてのオプションは、IDE、コマンドライン、および [Gradle](gradle-compiler-options.md) や [Maven](maven-kotlin-compiler.md#specify-compiler-options) で利用可能です。
