...
*   YouTrack課題: [KT-73255](https://youtrack.jetbrains.com/issue/KT-73255)
*   安定性レベル: [実験的](components-stability.md#stability-levels-explained)
*   提供開始バージョン: 2.2.0
...
*   提供開始バージョン: 2.2.20, 安定版となったバージョン: 2.3.0
...
*   提供開始バージョン: 2.2.0, 安定版となったバージョン: 2.3.0
...
*   YouTrack課題: [KT-80778](https://youtrack.jetbrains.com/issue/KT-80778)
*   提供開始バージョン: 2.1.0, 安定版となったバージョン: 2.3.0
