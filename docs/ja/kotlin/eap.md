 ...
 <table>
    ...
    <tr>
        <td><strong>2.3.20-RC2</strong>
            <p>リリース日: <strong>2026年3月3日</strong></p>
            <p><a href="https://github.com/JetBrains/kotlin/releases/tag/v2.3.20-RC2" target="_blank">GitHub でのリリース</a></p>
        </td>
        <td>
            <p>パフォーマンスの向上、バグ修正、およびツールのアップデートを含むツールリリースです。</p>
            <p>詳細については、<a href="https://github.com/JetBrains/kotlin/releases/tag/v2.3.20-RC2">チェンジログ</a>を参照してください。</p>
        </td>
    </tr>
</table>