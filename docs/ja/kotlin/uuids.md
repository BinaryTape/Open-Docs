...
## UUID から文字列への変換 {id="convert-uuids-to-strings"}
...
## バイナリ表現の操作 {id="work-with-binary-representations"}
...
## UUID のシリアライズ {id="serialize-uuids"}
...
## Java API での UUID の使用 {id="use-uuids-with-java-apis"}
