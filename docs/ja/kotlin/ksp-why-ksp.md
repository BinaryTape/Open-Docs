...
## KSP は軽量なコンパイラプラグインの作成を容易にする {id="ksp-makes-creating-lightweight-compiler-plugins-easier"}
...
## kotlinc コンパイラプラグインとの比較 {id="comparison-to-kotlinc-compiler-plugins"}
