...
## パラメーターの順序、命名、および使用方法を維持する {id="preserve-parameter-order-naming-and-usage"}
...
## データと状態にはオブジェクト指向設計を使用する {id="use-object-oriented-design-for-data-and-state"}
...
## 適切なエラーハンドリングメカニズムを選択する {id="choose-the-appropriate-error-handling-mechanism"}
...
## 規約と品質を維持する {id="maintain-conventions-and-quality"}
