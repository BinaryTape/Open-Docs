...
## 次のラウンドへのシンボルの遅延 {id="deferring-symbols-to-the-next-round"}
...
## シンボルのバリデーション {id="validating-symbols"}
...
## ファイルとシンボルへのアクセス {id="accessing-files-and-symbols"}
...
## プロセッサのインスタンス化 {id="processor-instantiation"}
...
## エラーと例外の処理 {id="error-and-exception-handling"}
