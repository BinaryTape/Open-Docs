...
## メソッドのオーバーライド {id="overriding-methods"}
...
## 派生クラスの初期化順序 {id="derived-class-initialization-order"}
...
## スーパークラスの実装の呼び出し {id="calling-the-superclass-implementation"}
...
## オーバーライドの規則 {id="overriding-rules"}
