...
[//]: # (TODO KT-85415: Kotlin/Wasmと互換性のあるスタンドアロンランタイムについては、Standalone runtimesを参照してください。)
...
> WebAssemblyコンポーネントモデルのサポートは、現在EAPリリースである[Kotlin %kotlinEapVersion%](whatsnew-eap.md)でのみ利用可能です。
>
{style="note"}
...
WebAssemblyコンポーネントモデルとKotlin/Wasmで何ができるかを探るには、[`wasi:http`で構築されたシンプルなサーバーのデモ](https://github.com/Kotlin/sample-wasi-http-kotlin/)をチェックしてください。
