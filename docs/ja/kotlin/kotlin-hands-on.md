...
Kotlin を使用した一連のハンズオンチュートリアルです。さまざまなテクノロジーを利用し、複数のプラットフォームをターゲットとしたアプリケーションを作成できます。
演習は一連のステップに分かれており、各セクションを順を追って進めることができます。

## Spring Boot と Kotlin による Web アプリケーションの作成 {id="creating-a-web-app-with-spring-boot-and-kotlin"}
...
## React と Kotlin/JS を使用した Web アプリケーションの構築 {id="building-web-applications-with-react-and-kotlin-js"}
...
## Spring Boot と Kotlin を使用した Web アプリケーションの構築 {id="building-web-applications-with-spring-boot-and-kotlin"}
...
## Ktor による HTTP API の作成 {id="creating-http-apis-with-ktor"}
...
## Ktor による WebSocket チャットの作成 {id="creating-a-websocket-chat-with-ktor"}
...
## Ktor による interactive な Web サイトの作成 {id="creating-an-interactive-website-with-ktor"}
...
## Kotlin コルーチンとチャネルの紹介 {id="introduction-to-kotlin-coroutines-and-channels"}
...
## Kotlin/Native 入門 {id="introduction-to-kotlin-native"}
...
## Kotlin Multiplatform: ネットワークとデータストレージ {id="kotlin-multiplatform-networking-and-data-storage"}
...
## Kotlin Multiplatform による iOS および Android への対応 {id="targeting-ios-and-android-with-kotlin-multiplatform"}
