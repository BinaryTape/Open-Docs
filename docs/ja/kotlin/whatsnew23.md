...
Kotlin 2.3.0 では、Swift エクスポートのサポートと C および Objective-C ライブラリのインポートの改善に加え、リリース用タスクのビルド時間短縮、Apple ターゲットサポートの変更が行われました。
...
今回のリリースでは、[Intel チップベース of Apple ターゲットの非推奨サイクル](whatsnew2220.md#deprecation-of-x86-64-apple-targets) も次のステップに進みます。
