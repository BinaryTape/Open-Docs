...
* [実行構成](#run-task)
* [テスト構成](#test-task)
* [バンドル](#webpack-bundling)およびブラウザプロジェクト用の[CSSサポート](#css)
...
Kotlinは、以下のES2015機能に対して[実験的（Experimental）](components-stability.md#stability-levels-explained)なサポートを提供しています。
