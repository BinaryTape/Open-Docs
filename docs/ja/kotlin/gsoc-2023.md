[//]: # (title: Kotlin と取り組む Google Summer of Code 2023)
...
### IntelliJ IDEA 用 Kotlin プラグインにおけるパラメータ転送のサポートを改善します [難易度：中, 350時間]
...
### kotlinx-benchmark ライブラリの API とユーザーエクスペリエンスを強化する [難易度：低, 175時間]
...
### デバッガーにおける Kotlin コルーチンのパラレルスタック [難易度：高, 350時間]
