...
- **マルチプラットフォーム開発**: Kotlin Multiplatformを使用して、JVM、JS、WasmJS、Android、およびiOSターゲットにエージェントをデプロイできます。
...
- **JVMおよびKotlinアプリケーションとの統合**: JVMおよびKotlin開発者向けに特別に設計された、イディオマティックで型安全なKotlin DSLを使用してAIエージェントを構築できます。
