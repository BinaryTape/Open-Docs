...
### 2. サーバーの作成 {id="2-create-the-server"}
...
### 3. トランスポート層の追加 {id="3-add-transport-layer"}
...
## エージェント実装パターン {id="agent-implementation-patterns"}

### シンプルレスポンス・エージェント {id="simple-response-agent"}
...
### タスクベース・エージェント {id="task-based-agent"}
