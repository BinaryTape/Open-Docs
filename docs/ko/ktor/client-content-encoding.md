...
아래 [예제](https://github.com/ktorio/ktor-documentation/tree/main/codeSnippets/snippets/client-content-encoding)는 사용자 정의 품질 값으로 `deflate` 및 `gzip` 인코더를 활성화하는 방법을 보여줍니다:
