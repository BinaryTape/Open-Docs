...
멀티플랫폼 모바일이나 풀스택 웹 애플리케이션 등 [멀티플랫폼 프로젝트](https://kotlinlang.org/docs/multiplatform.html)에서 사용할 수 있습니다. 멀티플랫폼 프로젝트를 위해 지원되는 [타겟](https://kotlinlang.org/docs/multiplatform-dsl-reference.html#targets)은 다음과 같습니다:
