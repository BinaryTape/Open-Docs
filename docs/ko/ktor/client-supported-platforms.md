...
다중 플랫폼 모바일 또는 풀스택 웹 애플리케이션과 같은 [다중 플랫폼 프로젝트](https://kotlinlang.org/docs/multiplatform.html)에서 Ktor HTTP 클라이언트를 사용할 수 있습니다. 다중 플랫폼 프로젝트에 대해 다음 [대상](https://kotlinlang.org/docs/multiplatform-dsl-reference.html#targets)이 지원됩니다:
