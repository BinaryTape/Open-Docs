...
### 고급 구성 파라미터 {id="advanced-configuration-parameters"}

#### 컨텍스트 테이크오버(Context takeover) {id="context-takeover"}
...
#### 압축 조건 지정 {id="specify-compress-condition"}
...
#### 프로토콜 목록 미세 조정 {id="fine-tune-list-of-protocols"}
