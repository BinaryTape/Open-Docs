...
<link-summary>HTML/CSS 또는 JVM 템플릿 엔진으로 구축된 뷰를 사용하는 방법에 대해 알아봅니다.</link-summary>
...
> 정적 HTML 파일을 제공하는 방법을 알아보려면 [정적 콘텐츠 제공(Serving static content)](server-static-content.md)을 참고하세요.