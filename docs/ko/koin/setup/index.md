...
## 권장 설정: BOM + 컴파일러 플러그인 (Compiler Plugin) {id="recommended-setup-bom-compiler-plugin"}
...
### [Gradle 설정](/docs/setup/gradle) {id="gradle-setup"}
...
### [컴파일러 플러그인 설정](/docs/setup/compiler-plugin) {id="compiler-plugin-setup"}
...
### [KSP 프로세서(Processor) 설정](/docs/setup/annotations-ksp) (더 이상 사용되지 않음) {id="ksp-processor-setup-deprecated"}
