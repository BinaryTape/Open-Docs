...
## 어디서부터 시작할까요? {id="where-to-start"}

경험 수준에 따라 학습 경로를 선택하세요:

### 의존성 주입이 처음이신가요? {id="new-to-dependency-injection"}

기본 개념부터 시작하세요:
- **[의존성 주입(Dependency Injection)이란 무엇인가요?](/docs/intro/what-is-dependency-injection)** - 핵심 개념 이해하기

### DI는 알지만 Koin은 처음이신가요? {id="know-di-new-to-koin"}
...
## Koin의 접근 방식 {id="koin-s-approaches"}
