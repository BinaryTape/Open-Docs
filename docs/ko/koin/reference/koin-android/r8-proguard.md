...
## Koin이 자동으로 유지하는 항목 (포함된 컨슈머 규칙) {id="what-koin-keeps-for-you-shipped-consumer-rules"}
...
## 직접 유지해야 하는 항목 {id="what-you-must-keep"}
...
## ViewModels & SavedStateHandle (#2044) {id="viewmodels-savedstatehandle-2044"}
...
## Android 이외의 타겟 (JS / WASM / Native) {id="non-android-targets-js-wasm-native"}
