...
### 리포지토리 패턴 (Repository Pattern) {id="repository-pattern"}
...
### 유스케이스 패턴 (Use Case Pattern) {id="use-case-pattern"}
...
### SavedStateHandle을 사용한 ViewModel {id="viewmodel-with-savedstatehandle"}
