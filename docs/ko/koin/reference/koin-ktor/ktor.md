...
## 왜 Ktor에서 Koin을 사용해야 하나요? {id="why-koin-for-ktor"}
...
### Ktor DI의 한계 {id="ktor-di-limitations"}
...
## 의존성 선언하기 {id="declaring-dependencies"}
...
## Koin 플러그인 설치 {id="installing-the-koin-plugin"}
...
### 애플리케이션 레벨 {id="application-level"}
