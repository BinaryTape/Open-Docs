...
Koog는 Kotlin 및 Java용 내장 도구(built-in tools)를 제공하여 에이전트와 사용자 간의 상호작용을 신속하게 프로토타입하고 실험할 수 있도록 돕습니다.
이 도구들은 프로덕션 용도로 설계되지 않았습니다. 이를 사용하려면 종속성에 `ai.koog:agents-ext`를 추가하세요.
...
Kotlin과 Java 모두에서 동일한 레지스트리 내에 내장 도구와 커스텀 도구를 결합하여 에이전트를 위한 포괄적인 기능 세트를 구성할 수 있습니다.
커스텀 도구에 대해 자세히 알아보려면 [Annotation-based tools](annotation-based-tools.md) 및 [Class-based tools](class-based-tools.md)를 참조하세요.