...
-   :material-shield-check-outline:{ .lg .middle } [**모듈 버전 관리**](module-versioning.md)

    ---

    안정 버전(stable) 및 베타(beta) 모듈과 API 보장 정책 이해
...
-   :material-list-status:{ .lg .middle } [**플래너 에이전트**](agents/planner-agents/index.md) <span class="beta-badge" title="Beta — API may change">beta</span>
...
-   :material-tools:{ .lg .middle } [**도구**](tools/index.md)
...
-   :material-history:{ .lg .middle } [**기록 압축**](history-compression.md)
    ...
    고급 기술을 사용하여 장기간 대화에서 컨텍스트를 유지하면서 토큰 사용량 최적화
...
-   :material-database-search:{ .lg .middle } [**지식 검색**](embeddings.md) <span class="beta-badge" title="Beta — API may change">beta</span>
...
-   :material-timeline-text:{ .lg .middle } [**장기 메모리**](features/long-term-memory.md) <span class="beta-badge" title="Beta — API may change">beta</span>
