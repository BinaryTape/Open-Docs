...
-   :material-toy-brick-outline:{ .lg .middle } [**기능**](features-overview.md)
...
-   :material-floppy:{ .lg .middle } [**에이전트 영속성**](agent-persistence.md)
...
-   :material-database-search:{ .lg .middle } [**지식 검색**](embeddings.md)
    ...
    [벡터 임베딩](embeddings.md), [랭크된 문서 저장소](ranked-document-storage.md) 및 [공유 에이전트 메모리](agent-memory.md)를 사용하여 여러 대화에 걸쳐 지식을 유지하고 검색
...
-   :material-timeline-text:{ .lg .middle } [**장기 메모리**](long-term-memory.md)
