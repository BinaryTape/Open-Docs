...
## 에이전트 생성 및 Weave 트레이싱 활성화 {id="create-an-agent-and-enable-weave-tracing"}
...
## 에이전트 실행 및 Weave에서 트레이스 확인 {id="run-the-agent-and-view-traces-in-weave"}
