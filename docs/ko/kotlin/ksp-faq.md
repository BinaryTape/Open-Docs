...
### 왜 KSP가 kapt보다 더 빠른가요? {id="why-is-ksp-faster-than-kapt"}
...
### 최신 KSP 구현체를 이전 버전의 Kotlin 컴파일러와 함께 사용할 수 있나요? {id="can-i-use-a-newer-ksp-implementation-with-an-older-kotlin-compiler"}
...
### KSP는 얼마나 자주 업데이트되나요? {id="how-often-do-you-update-ksp"}
...
### Kotlin 외에 라이브러리에 대한 다른 버전 요구 사항이 있나요? {id="besides-kotlin-are-there-other-version-requirements-for-libraries"}

라이브러리 및 인프라에 대한 요구 사항 목록은 다음과 같습니다:
* Android Gradle 플러그인 7.1.3+
* Gradle 6.8.3+

### KSP의 향후 로드맵은 무엇인가요? {id="what-is-ksp-s-future-roadmap"}
