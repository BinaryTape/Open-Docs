...
_[언어 현대화 유지](kotlin-evolution-principles.md)_ 및 _[편리한 업데이트](kotlin-evolution-principles.md)_는 Kotlin 언어 설계의 근본적인 원칙 중 하나입니다. 전자는 언어 발전을 방해하는 구성 요소는 제거되어야 한다고 말하며, 후자는 이러한 제거가 코드 마이그레이션을 최대한 원활하게 하기 위해 사전에 충분히 공지되어야 한다고 말합니다.
...
> **Issue**: [KT-25289](https://youtrack.com/issue/KT-25289)
>
> **구성 요소**: 코어 언어
>
> **비호환성 변경 유형**: 소스 (source)
...
> **비호환성 변경 유형**: 소스 (source)
>
> **요약**: Kotlin/JS의 `Regex.replace` 함수에서 함수형 `transform` 파라미터를 가진 `Regex.replace` 함수는 더 이상 인라인이 아닙니다.
>
> **Deprecation cycle**:
>
