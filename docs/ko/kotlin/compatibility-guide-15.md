...
_[언어 현대성 유지](kotlin-evolution-principles.md)_ 및 _[편리한 업데이트](kotlin-evolution-principles.md)_는 Kotlin 언어 설계의 기본 원칙 중 일부입니다. 전자는 언어 발전을 방해하는 구조는 제거되어야 한다고 말하며, 후자는 이러한 제거는 코드 마이그레이션을 가능한 한 원활하게 하기 위해 사전에 잘 전달되어야 한다고 말합니다.
...
> **사용 중단 주기**:
>
> - < 1.5: 기본적으로 이전 JVM 백엔드 사용. 본문에 선언된 필드를 생성자에 선언된 필드보다 먼저 가집니다.
