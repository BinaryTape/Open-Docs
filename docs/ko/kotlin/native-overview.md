...
## 왜 Kotlin/Native인가요? {id="why-kotlin-native"}
...
### C와의 상호운용성 {id="interoperability-with-c"}
...
### Swift/Objective-C와의 상호운용성 {id="interoperability-with-swift-objective-c"}
...
## 플랫폼 간 코드 공유 {id="sharing-code-between-platforms"}
