...
| `languageVersion` | `kotlin.compiler.languageVersion` | 지정된 버전의 Kotlin과 소스 호환성 제공                                                                                                                                                               | "2.0", "2.1", "2.2", "2.3", "2.4", "2.5" (실험적) |                                |
| `apiVersion`      | `kotlin.compiler.apiVersion`      | 번들된 라이브러리의 지정된 버전에서 제공하는 선언만 사용하도록 허용                                                                                                                                   | "2.0", "2.1", "2.2", "2.3", "2.4", "2.5" (실험적) |                                |
