...
* KEEP
  제안: [dfa-exhaustiveness.md](https://github.com/Kotlin/KEEP/blob/main/proposals/KEEP-0442-dfa-exhaustiveness.md)
* YouTrack 이슈: [KT-8781](https://youtrack.jetbrains.com/issue/KT-8781)
* 안정성 수준: [베타](components-stability.md#stability-levels-explained)
* 사용 가능 버전: 2.2.20
...
* KEEP
  제안: [Improvements to annotation use-site targets on properties](https://github.com/Kotlin/KEEP/blob/master/proposals/annotation-target-in-properties.md)
...
* KEEP
  제안: [Nested (non-capturing) type aliases](https://github.com/Kotlin/KEEP/blob/master/proposals/nested-typealias.md)
