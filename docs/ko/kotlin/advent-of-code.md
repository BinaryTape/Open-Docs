...
## Advent of Code 준비하기 {id="get-ready-for-advent-of-code"}
...
### Day 1: Calorie counting {id="day-1-calorie-counting"}
...
### Day 2: Rock paper scissors {id="day-2-rock-paper-scissors"}
...
### Day 3: Rucksack reorganization {id="day-3-rucksack-reorganization"}
...
### Day 4: Camp cleanup {id="day-4-camp-cleanup"}
...
### Day 5: Supply stacks {id="day-5-supply-stacks"}
...
### Day 6: Tuning trouble {id="day-6-tuning-trouble"}
...
### Day 7: No space left on device {id="day-7-no-space-left-on-device"}
...
### Day 8: Treetop tree house {id="day-8-treetop-tree-house"}
...
### Day 9: Rope bridge {id="day-9-rope-bridge"}
...
### Day 10: Cathode-ray tube {id="day-10-cathode-ray-tube"}
...
### Day 11: Monkey in the middle {id="day-11-monkey-in-the-middle"}
...
### Day 12: Hill Climbing algorithm {id="day-12-hill-climbing-algorithm"}
...
### Day 1: Sonar sweep {id="day-1-sonar-sweep"}
...
### Day 3: Binary diagnostic {id="day-3-binary-diagnostic"}
...
### Day 4: Giant squid {id="day-4-giant-squid"}
...
### Day 1: Report repair {id="day-1-report-repair"}
...
### Day 2: Password philosophy {id="day-2-password-philosophy"}
...
### Day 3: Toboggan trajectory {id="day-3-toboggan-trajectory"}
...
### Day 4: Passport processing {id="day-4-passport-processing"}
...
### Day 5: Binary boarding {id="day-5-binary-boarding"}
...
### Day 6: Custom customs {id="day-6-custom-customs"}
...
### Day 7: Handy haversacks {id="day-7-handy-haversacks"}
...
### Day 8: Handheld halting {id="day-8-handheld-halting"}
...
### Day 9: Encoding error {id="day-9-encoding-error"}
