 ...
 <table>
    ...
    <tr>
        <td><strong>2.3.20-RC3</strong>
            <p>출시일: <strong>2026년 3월 10일</strong></p>
            <p><a href="https://github.com/JetBrains/kotlin/releases/tag/v2.3.20-RC3" target="_blank">GitHub에서 릴리스 보기</a></p>
        </td>
        <td>
            <p>성능 향상, 버그 수정 및 도구 업데이트가 포함된 도구(tooling) 릴리스입니다.</p>
            <p>자세한 내용은 <a href="https://github.com/JetBrains/kotlin/releases/tag/v2.3.20-RC3">변경 로그(changelog)</a>를 참고하세요.</p>
        </td>
    </tr>
</table> 
-->