...
* 아이디어를 시도하고 사용자들의 사용 경험과 피드백을 얻으려는 단계입니다. 결과가 좋지 않다면 언제든지 제거될 수 있습니다.

**Alpha**는 "위험을 감수하고 사용하세요. 마이그레이션 문제를 예상해야 합니다"라는 의미입니다.
* 아이디어를 제품화(productize)할 계획이지만, 아직 최종 형태를 갖추지 못한 상태입니다.
