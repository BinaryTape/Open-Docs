...
## 심볼을 다음 라운드로 지연시키기 {id="deferring-symbols-to-the-next-round"}
...
## 심볼 유효성 검사 {id="validating-symbols"}
...
## 파일 및 심볼 접근 {id="accessing-files-and-symbols"}
...
## 프로세서 인스턴스화 {id="processor-instantiation"}
...
## 에러 및 예외 처리 {id="error-and-exception-handling"}
