[//]: # (title: Compose Multiplatform 1.11.0-beta01의 새로운 기능)

이번 EAP 기능 릴리스의 주요 하이라이트는 다음과 같습니다.

* [iOS 네이티브 텍스트 입력](#native-text-input)
* [웹 타겟의 스크롤 성능을 네이티브 UI 수준으로 개선](#scroll-on-web-targets-brought-in-line-with-native-ui)

전체 변경 사항 목록은 [GitHub](https://github.com/JetBrains/compose-multiplatform/releases/tag/v1.11.0-beta01)에서 확인할 수 있습니다.
