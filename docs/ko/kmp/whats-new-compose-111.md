[//]: # (title: Compose Multiplatform 1.11.0-beta02의 새로운 기능)
...
전체 변경 사항 목록은 [GitHub](https://github.com/JetBrains/compose-multiplatform/releases/tag/v1.11.0-beta02)에서 확인할 수 있습니다.
