...
## 비즈니스 및 팀 유형별 Kotlin Multiplatform 활용 사례 {id="kotlin-multiplatform-use-cases-by-the-type-of-business-and-team"}

다양한 팀들이 프로젝트의 요구 사항을 충족하기 위해 Kotlin Multiplatform을 적용하는 몇 가지 방식은 다음과 같습니다.

### 새로운 그린필드(Greenfield) 프로젝트를 시작하는 스타트업 {id="startups-starting-a-new-greenfield-project"}
...
### 중소기업 {id="small-and-medium-sized-businesses"}
...
### 애플리케이션 전반에서 기기 간 일관된 동작이 필요한 엔터프라이즈 기업 {id="enterprises-that-need-consistent-behavior-across-devices-for-their-applications"}
...
### 새로운 시장으로 확장하려는 기업 {id="companies-expanding-to-new-markets"}
...
### 소프트웨어 개발 키트(SDK)를 개발하는 팀 {id="teams-developing-software-development-kits-sdk"}
...
## 산업별 Kotlin Multiplatform 활용 사례 {id="kotlin-multiplatform-use-cases-by-industry"}
...
### 금융 기술 (핀테크) {id="financial-technology"}
...
### 미디어 및 출판 {id="media-and-publishing"}
...
### 프로젝트 관리 및 생산성 {id="project-management-and-productivity"}
...
### 교통 및 모빌리티 {id="transportation-and-mobility"}
...
### 교육 기술 (에듀테크) {id="educational-technology"}
...
### 소셜 네트워킹 및 커뮤니티 {id="social-networking-and-community"}
...
### 건강 및 웰니스 {id="health-and-wellness"}
