...
구글은 오랫동안 Compose를 발전시키고 풍부하게 만들어 왔습니다. 가장 일반적인 시나리오에 대한 도움을 얻으려면 [Jetpack Compose 마이그레이션 가이드](https://developer.android.com/develop/ui/compose/migrate)를 확인하세요.
...
Jetcaster의 경우, 단순화된 모듈 의존성 그래프는 다음과 같습니다.
