...
* 각 목적지에는 연결된 _딥 링크(deep link)_ 세트가 있을 수 있습니다. 이는 앱이 운영 체제로부터 링크를 받을 때 해당 목적지로 이어져야 하는 URI 패턴입니다.
...
> Compose Multiplatform %org.jetbrains.compose%에는 Navigation 라이브러리 버전 %org.jetbrains.androidx.navigation%이 필요합니다.
>
{style="note"}
