...
| `specRepos`                           | `url()`을 사용하여 사양 리포지토리를 추가합니다. 이는 개인 Pod가 의존성으로 사용될 때 필요합니다. 자세한 내용은 [CocoaPods 문서](https://guides.cocoapods.org/making/private-cocoapods.html)를 참조하십시오. |
