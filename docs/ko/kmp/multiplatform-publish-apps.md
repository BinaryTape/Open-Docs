...
### iOS 애플리케이션 구성 {id="configure-your-ios-application"}

Xcode 없이도 결과 앱에 영향을 미치는 기본 속성을 구성할 수 있습니다.

#### 번들 ID (Bundle ID) {id="bundle-id"}
...
### 크래시 리포트 심볼 복원 (Symbolicating crash reports) {id="symbolicating-crash-reports"}
...
### TestFlight 게시 자동화 {id="automate-publishing-to-testflight"}
...
### GitHub Pages에 애플리케이션 게시하기 {id="publish-your-application-on-github-pages"}
...
### 웹 애플리케이션 디버깅 {id="debug-your-web-application"}
