...
### accessibilityEnabled가 isNativeAccessibilityEnabled로 교체되었으며, 기본적으로 비활성화됨 {id="accessibilityenabled-replaced-by-isnativeaccessibilityenabled-and-turned-off-by-default"}
...
### 일부 onReset 사용 패턴이 무효화됨 {id="some-onreset-usage-patterns-were-invalidated"}
