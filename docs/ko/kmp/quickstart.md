...
Android 실행 구성을 수동으로 만들려면 실행 구성 템플릿으로 **Android App**을 선택하고 모듈로 **[프로젝트 이름].androidApp**을 선택합니다.
...
* 네이티브 UI가 있는 프로젝트에서 공유 코드를 사용하는 튜토리얼 시리즈: [Kotlin Multiplatform 앱 만들기](multiplatform-create-first-app.md)
