## 타입 추론 (Type Inference) {id="type-inference"}
...
## 이름이 지정된 인자 (Named Arguments) {id="named-arguments"}
...
## 가변 인자 (Variable Arguments) {id="variable-arguments"}
...
## 입력값 정제 (Input Sanitization) {id="input-sanitization"}
