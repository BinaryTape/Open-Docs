...
|-----------------------------------------------|------------------------------|------------------------|--------------------------------------|----------|------------------|------------------|------------------------|-----------------------------------|-----------------------|
| 支援的輸入                                    | 文字、圖像、音訊、文件       | 文字、圖像、文件[^1] | 文字、圖像、音訊、視訊、文件[^1] | 文字     | 依模型而異       | 依模型而異       | 文字、圖像、文件[^1] | 文字、圖像、音訊、視訊[^1]          | 文字、圖像[^1]           |
| 回應串流                                      | ✓                            | ✓                      | ✓                                    | ✓        | ✓                | ✓                | ✓                      | ✓                                 | ✓                     |
| 工具                                          | ✓                            | ✓                      | ✓                                    | ✓        | ✓                | ✓[^1]            | ✓                      | ✓                                 | ✓                     |
| 工具選擇                                      | ✓                            | ✓                      | ✓                                    | ✓        | ✓                | ✓[^1]            | ✓                      | ✓                                 | –                     |
...
!!! note
    ...
    欲了解更多，請參閱 [Model capabilities](model-capabilities.md)。
...
*   使用 **LLM 用戶端** 與特定提供者直接互動。
    ...
    詳情請參閱 [LLM clients](prompts/llm-clients.md)。
...
*   使用 **提示執行器** 進行更高層次的抽象，它封裝一個或多個 LLM 用戶端，
    ...
    詳情請參閱 [Prompt executors](prompts/prompt-executors.md)。
