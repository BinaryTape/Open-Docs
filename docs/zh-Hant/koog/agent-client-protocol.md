...
ACP 支援是一個選用的 [功能 (feature)](features-overview.md)，預設情況下 Koog 不提供。
...
如需有關將自訂代理新增至 IDE 的更多資訊，請參閱 [AI Assistant 文件](https://www.jetbrains.com/help/ai-assistant/acp.html#add-custom-agent)以及[這篇部落格文章](https://blog.jetbrains.com/ai/2026/02/koog-x-acp-connect-an-agent-to-your-ide-and-more/)。
