...
## 建立 agent 並啟用 Weave 執行緒 {id="create-an-agent-and-enable-weave-tracing"}
...
## 執行 agent 並在 Weave 中查看追蹤 {id="run-the-agent-and-view-traces-in-weave"}
