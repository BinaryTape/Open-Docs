...
* KEEP
  提案：[dfa-exhaustiveness.md](https://github.com/Kotlin/KEEP/blob/main/proposals/KEEP-0442-dfa-exhaustiveness.md)
* YouTrack 問題：[KT-8781](https://youtrack.jetbrains.com/issue/KT-8781)
* 穩定性等級：[Beta](components-stability.md#stability-levels-explained)
* 自 2.2.20 起提供
...
* KEEP
  提案：[Improvements to annotation use-site targets on properties](https://github.com/Kotlin/KEEP/blob/master/proposals/annotation-target-in-properties.md)
...
* KEEP
  提案：[Nested (non-capturing) type aliases](https://github.com/Kotlin/KEEP/blob/master/proposals/nested-typealias.md)
