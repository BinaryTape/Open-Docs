...
<deflist collapsible="true">
   ...
   <def title="可變參數 – args: Array&lt;String&gt;">
      <p>如果您查看 <code>runApplication()</code> 函式的宣告，會發現該函式的參數標有 <a href="functions.md#variable-number-of-arguments-varargs"><code>vararg 修飾詞</code></a>：<code>vararg args: String</code>。
