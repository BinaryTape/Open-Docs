...
## Kotlin 解決的一些 Java 問題 {id="some-java-issues-addressed-in-kotlin"}
...
## Java 擁有但 Kotlin 沒有的特性 {id="what-java-has-that-kotlin-does-not"}
...
## Kotlin 擁有但 Java 沒有的特性 {id="what-kotlin-has-that-java-does-not"}
