...
1. [套用 Kotlin Maven 外掛程式](maven-configure-project.md#enable-and-configure-the-plugin)。
2. [宣告儲存庫](maven-configure-project.md#declare-repositories)。
3. [設定專案相依性](maven-configure-project.md#set-dependencies)。
...
6. [封裝您的應用程式](maven-compile-package.md#package-your-project)。
