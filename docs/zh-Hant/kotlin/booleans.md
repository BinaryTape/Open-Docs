...
## 宣告 `Boolean` 變數 {id="declare-a-boolean-variable"}
...
## 產出 `Boolean` 值 {id="produce-boolean-values"}
...
## `Boolean` 運算 {id="boolean-operations"}
...
## 條件中的 `Boolean` {id="boolean-in-conditions"}
