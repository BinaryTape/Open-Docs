...
## Kotlin 針對 Google Summer of Code (GSoC) 的貢獻者指南 {id="kotlin-contributor-guidelines-for-google-summer-of-code-gsoc"}
...
### Kotlin 編譯器 Fuzzer (Kai) [困難, 350 小時] {id="kotlin-compiler-fuzzer-kai-hard-350-hrs"}
...
### Swift 到 Kotlin 的互通性 (PoC) [困難, 350 小時] {id="swift-to-kotlin-interop-poc-hard-350-hrs"}
...
### Kotlin/Wasm 後端的尾呼叫支援 [中等, 90 小時] {id="tail-call-support-in-the-kotlin-wasm-backend-medium-90-hrs"}
...
### Kotlin 教育現狀報告 [中等, 175 小時] {id="kotlin-education-landscape-report-medium-175-hrs"}
