[//]: # (title: Kotlin Notebook 快速入門)

> 從 IntelliJ IDEA 2026.2 開始，Kotlin Notebook 將不再隨 IDE 隨附，也不再由 JetBrains 提供官方支援。
> 原始碼仍可在 [GitHub](https://github.com/Kotlin/kotlin-notebook) 上取得。
>
> 在 [部落格文章](https://blog.jetbrains.com/idea/2026/06/kotlin-notebook-sunset/) 中了解更多資訊。
>
{style="note"}

[Kotlin Notebook](kotlin-notebook-overview.md) 是一款互動式工具，可讓您在單一文件中混合程式碼、視覺化內容與 Markdown。
您可以使用 Notebook 在稱為「_程式碼資料格_」的區段中編寫並執行程式碼，即時查看結果並記錄您的想法。
這種設定使其成為快速原型開發、分析與資料科學的優質工具。
