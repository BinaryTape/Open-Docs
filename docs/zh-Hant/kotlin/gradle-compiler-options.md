...
| `jvmTarget`               | 生成的 JVM 位元組碼的目標版本                                                                                                                                                                                                 | "1.8", "9", "10", ...,  "24", "25"。另請參閱 [編譯器選項的型別](#types-for-compiler-options) | "%defaultJvmTargetVersion%" |
...
| `apiVersion`          | 限制宣告的使用，僅限於指定版本捆綁程式庫中的宣告                                                                                                                                              | "1.9", "2.0", "2.1", "2.2", "2.3", "2.4" (EXPERIMENTAL) |               |
| `languageVersion`     | 提供與指定 Kotlin 版本的原始碼相容性                                                                                                                                       | "1.9", "2.0", "2.1", "2.2", "2.3", "2.4" (EXPERIMENTAL) |               |
