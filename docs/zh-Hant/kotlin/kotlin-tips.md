...
## 消除集合項目中的重複項 {id="deduplicating-collection-items"}
...
## suspend 與內嵌的奧秘 {id="the-suspend-and-inline-mystery"}
...
## 使用完全限定名稱取消遮蔽宣告 {id="unshadowing-declarations-with-their-fully-qualified-name"}
...
## 搭配 Elvis 運算子使用 return 與 throw {id="return-and-throw-with-the-elvis-operator"}
...
## 解構宣告 {id="destructuring-declarations"}
...
## 搭配可 null 值的運算子函式 {id="operator-functions-with-nullable-values"}
...
## Elvis 運算子的更多用法 {id="doing-more-with-the-elvis-operator"}
