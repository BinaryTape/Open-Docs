...
Kotlin 可用於任何類型的開發，無論是伺服器端開發、用戶端 Web、Android 還是多平台程式庫。
...
* Peter Sommerhoff 的 [Udemy 課程：10 Kotlin Tutorials for Beginners](https://petersommerhoff.com/dev/kotlin/kotlin-beginner-tutorial/)
