...
## 支援的工作流 {id="supported-workflows"}

您可以將 Kotlin AI 技能用於不同的 Kotlin 特定場景。以下範例展示了 AI 技能可以協助您完成的一些任務。

### 將 Java 原始程式檔轉換為 Kotlin {id="convert-java-source-files-to-kotlin"}
...
### 遷移包含 Android 應用程式的多平台專案以使用 AGP 9 {id="migrate-multiplatform-projects-with-android-apps-to-use-agp-9"}
...
### 將多平台專案從 CocoaPods 遷移至 SwiftPM 相依性 {id="migrate-multiplatform-projects-from-cocoapods-to-swiftpm-dependencies"}
