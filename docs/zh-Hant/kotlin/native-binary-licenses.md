...
如同許多其他開源專案，Kotlin 依賴第三方程式碼，這代表 Kotlin 專案中包含一些並非由 JetBrains 或 Kotlin 程式語言貢獻者所開發的程式碼。
...
<table>
   ...
   <tr>
        <td><a href="https://www.unicode.org/">Unicode 字元資料庫 (Unicode character database)</a></td>
