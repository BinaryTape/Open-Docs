...
## 建立開發計畫 {id="create-a-development-plan"}
...
## 測試應用程式 {id="test-the-app"}

現在是您測試應用程式的時候了。

### 手動測試 UI {id="test-the-ui-manually"}
