...
## 依業務類型和團隊劃分的 Kotlin 多平台使用案例 {id="kotlin-multiplatform-use-cases-by-the-type-of-business-and-team"}

以下是不同團隊應用 Kotlin 多平台以滿足各種專案需求的幾種方式：

### 啟動全新專案的新創公司 {id="startups-starting-a-new-greenfield-project"}
...
### 中小型企業 {id="small-and-medium-sized-businesses"}
...
### 需要在裝置間保持一致行為的大型企業應用程式 {id="enterprises-that-need-consistent-behavior-across-devices-for-their-applications"}
...
### 擴展至新市場的公司 {id="companies-expanding-to-new-markets"}
...
### 開發軟體開發套件 (SDK) 的團隊 {id="teams-developing-software-development-kits-sdk"}
...
## 依行業劃分的 Kotlin 多平台使用案例 {id="kotlin-multiplatform-use-cases-by-industry"}
...
### 專案管理與生產力 {id="project-management-and-productivity"}
...
### 交通與運輸 {id="transportation-and-mobility"}
...
### 社群網路與社群 {id="social-networking-and-community"}
