...
要透過本機 CocoaPods 相依性設定工作流程，您可以手動編輯指令碼。

若要了解更多，請參閱 [CocoaPods 總覽與設定](multiplatform-cocoapods-overview.md)。
...
若要了解更多，請參閱 [建置最終原生二進制檔案](multiplatform-build-native-binaries.md#build-frameworks)。