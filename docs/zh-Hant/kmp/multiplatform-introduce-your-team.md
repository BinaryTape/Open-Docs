...
* [使用案例研究來展示多平台開發的價值](#use-case-studies-to-demonstrate-the-value-of-multiplatform-development)
...
JetBrains 團隊期待聽到 [您關於使用 Kotlin Multiplatform 的故事](mailto:kotlin.multiplatform.feedback@kotlinlang.org)。
