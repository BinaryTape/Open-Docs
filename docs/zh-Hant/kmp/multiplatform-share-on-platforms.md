...
## 在所有平台上分享程式碼 {id="share-code-on-all-platforms"}
...
## 在相似平台上分享程式碼 {id="share-code-on-similar-platforms"}
...
## 在程式庫中分享程式碼 {id="share-code-in-libraries"}
...
## 連接平台特定程式庫 {id="connect-platform-specific-libraries"}
