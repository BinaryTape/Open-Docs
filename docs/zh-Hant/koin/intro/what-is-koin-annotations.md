...
### 熟悉的註解樣式 — 主 Koin 專案的一部分 {id="familiar-annotation-style-part-of-the-main-koin-project"}
...
## 主 Koin 專案的一部分 {id="part-of-the-main-koin-project"}
...
## 現在由 Koin Compiler Plugin 提供支援 {id="now-powered-by-the-koin-compiler-plugin"}
...
## `koin-ksp-compiler` 已棄用 {id="koin-ksp-compiler-is-deprecated"}
...
## 何時選擇註解 {id="when-to-choose-annotations"}
