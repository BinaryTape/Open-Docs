...
## Koin 為您保留的內容 (隨附的取用者規則) {id="what-koin-keeps-for-you-shipped-consumer-rules"}
...
## 您必須保留的內容 {id="what-you-must-keep"}
...
## ViewModels 與 SavedStateHandle (#2044) {id="viewmodels-savedstatehandle-2044"}
...
## 非 Android 目標 (JS / WASM / Native) {id="non-android-targets-js-wasm-native"}
