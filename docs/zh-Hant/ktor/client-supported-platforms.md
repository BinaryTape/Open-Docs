...
Ktor HTTP 用戶端可用於 Kotlin 支援的不同平台：
- JVM
...
您可以將其用於[多平台專案](https://kotlinlang.org/docs/multiplatform.html)，無論是多平台行動應用程式還是全端 Web 應用程式。多平台專案支援以下[目標](https://kotlinlang.org/docs/multiplatform-dsl-reference.html#targets)：
