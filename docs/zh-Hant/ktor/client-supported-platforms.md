...
Ktor HTTP 用戶端可在 Kotlin 支援的不同平台上使用：
- JVM
...
您可以在[多平台專案](https://kotlinlang.org/docs/multiplatform.html)中使用它，無論是多平台行動應用程式還是全端網頁應用程式。以下[目標](https://kotlinlang.org/docs/multiplatform-dsl-reference.html#targets)支援用於多平台專案：
