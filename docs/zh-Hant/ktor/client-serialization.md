...
> 請注意，`jsNode` 目標 [不支援 XML 序列化](https://github.com/pdvrieze/xmlutil/issues/83)。
{style="note"}
...
您可以在這裡找到完整的範例：[client-json-kotlinx](https://github.com/ktorio/ktor-documentation/tree/%ktor_version%/codeSnippets/snippets/client-json-kotlinx)。
