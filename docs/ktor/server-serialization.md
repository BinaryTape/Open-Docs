...
在这种情况下，Ktor 使用 `Accept` 标头来选择所需的[序列化程序](#configure_serializer)。您可以在此处找到完整示例：[json-kotlinx](https://github.com/ktorio/ktor-documentation/tree/%ktor_version%/codeSnippets/snippets/json-kotlinx)。
