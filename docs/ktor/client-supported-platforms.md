...
Ktor HTTP 客户端可用于 Kotlin 支持的不同平台：
- JVM
...
你可以在[多平台项目](https://kotlinlang.org/docs/multiplatform.html)中使用它，无论是多平台移动应用还是全栈 Web 应用程序。以下[目标](https://kotlinlang.org/docs/multiplatform-dsl-reference.html#targets)支持多平台项目：
