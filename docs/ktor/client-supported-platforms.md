...
您可以在[多平台项目](https://kotlinlang.org/docs/multiplatform.html)中使用它，无论是多平台移动端还是全栈 Web 应用程序。多平台项目支持以下[目标](https://kotlinlang.org/docs/multiplatform-dsl-reference.html#targets)：
