...
## 导航图 ViewModel {id="navigation-graph-viewmodel"}
...
## 带有作用域限定依赖项的 ViewModel {id="viewmodel-with-scoped-dependencies"}
...
## Java 兼容性 {id="java-compatibility"}
