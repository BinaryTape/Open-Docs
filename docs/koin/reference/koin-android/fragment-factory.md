...
### 配置 Fragment Factory {id="configure-fragment-factory"}
...
## 声明 Fragment {id="declaring-fragments"}
...
### 在 Activity 中设置 {id="setup-in-activity"}
...
## 带有作用域的 Fragment Factory {id="fragment-factory-with-scopes"}
