...
### 基础 logger 跟踪 {id="basic-tracing-to-logger"}
...
## 错误处理与极端情况 {id="error-handling-and-edge-cases"}
...
### 将特定事件跟踪到文件 {id="tracing-specific-events-to-file"}
...
### 将特定事件跟踪到远程端点 {id="tracing-specific-events-to-remote-endpoint"}
