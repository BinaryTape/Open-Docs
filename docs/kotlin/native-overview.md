...
## 为什么选择 Kotlin/Native？ {id="why-kotlin-native"}
...
### 与 C 的互操作性 {id="interoperability-with-c"}
...
### 与 Swift/Objective-C 的互操作性 {id="interoperability-with-swift-objective-c"}
...
## 在平台间共享代码 {id="sharing-code-between-platforms"}
