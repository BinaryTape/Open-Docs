...
## 保持形参顺序、命名和用法的一致性 {id="preserve-parameter-order-naming-and-usage"}
...
## 对数据和状态使用面向对象设计 {id="use-object-oriented-design-for-data-and-state"}
...
## 选择合适的错误处理机制 {id="choose-the-appropriate-error-handling-mechanism"}
...
## 维护约定与质量 {id="maintain-conventions-and-quality"}
