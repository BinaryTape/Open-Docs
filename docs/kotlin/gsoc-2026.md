...
## Kotlin 贡献者指南 – Google Summer of Code (GSoC) {id="kotlin-contributor-guidelines-for-google-summer-of-code-gsoc"}
...
### Kotlin 编译器模糊测试器 (Kai) [困难, 350 小时] {id="kotlin-compiler-fuzzer-kai-hard-350-hrs"}
...
### Swift 到 Kotlin 的互操作 (PoC) [困难, 350 小时] {id="swift-to-kotlin-interop-poc-hard-350-hrs"}
...
### Kotlin/Wasm 后端中的尾调用支持 [中等, 90 小时] {id="tail-call-support-in-the-kotlin-wasm-backend-medium-90-hrs"}
...
### Kotlin 教育现状报告 [中等, 175 小时] {id="kotlin-education-landscape-report-medium-175-hrs"}
