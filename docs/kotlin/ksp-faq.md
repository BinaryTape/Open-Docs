...
### 为什么 KSP 比 kapt 快？ {id="why-is-ksp-faster-than-kapt"}
...
### 我可以在旧版 Kotlin 编译器中使用新版 KSP 实现吗？ {id="can-i-use-a-newer-ksp-implementation-with-an-older-kotlin-compiler"}
...
### 除了 Kotlin，库还有其他版本要求吗？ {id="besides-kotlin-are-there-other-version-requirements-for-libraries"}

以下是库/基础架构的要求列表：
* Android Gradle 插件 7.1.3+
* Gradle 6.8.3+

### KSP 未来的路线图是什么？ {id="what-is-ksp-s-future-roadmap"}
