...
本教程演示如何在 IntelliJ IDEA 中运行包含 [](wasm-overview.md) 的 [Compose Multiplatform](https://www.jetbrains.com/lp/compose-multiplatform/) 应用，并生成作为网站一部分发布的构建工件。
...
![在 Web 上运行 Compose Multiplatform 应用](compose-run-web-black.png){width=300}
