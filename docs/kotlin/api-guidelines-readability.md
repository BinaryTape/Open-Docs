...
## 优先选择显式组合性 {id="prefer-explicit-composability"}
...
## 使用扩展函数与属性 {id="use-extension-functions-and-properties"}
...
## 避免使用布尔类型作为实参 {id="avoid-using-the-boolean-type-as-an-argument"}
...
## 正确使用数值类型 {id="use-numeric-types-appropriately"}
