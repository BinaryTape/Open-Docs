...
### Kotlin/JS 用例 {id="kotlin-js-use-cases"}
...
#### 与 JavaScript/TypeScript 代码库共享业务逻辑 {id="share-business-logic-with-a-javascript-typescript-codebase"}
...
#### 使用 Kotlin 构建 Web 应用而不共享代码 {id="build-web-apps-with-kotlin-without-sharing-the-code"}
...
### Kotlin/Wasm 用例 {id="kotlin-wasm-use-cases"}

如果您想在多个平台之间同时共享逻辑和 UI，请使用 Kotlin/Wasm。

#### 使用 Compose Multiplatform 构建跨平台应用 {id="build-cross-platform-apps-with-compose-multiplatform"}
...
## 选择您的 Web 方案 {id="choose-your-web-approach"}
...
## Web 目标的兼容性模式 {id="compatibility-mode-for-web-targets"}
