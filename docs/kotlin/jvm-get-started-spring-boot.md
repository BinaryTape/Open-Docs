...
<web-summary>Spring Boot 与 Kotlin 入门。使用 Kotlin 创建 Spring Boot 应用程序。</web-summary>

通过完成本教程开始使用 Spring Boot 与 Kotlin：它将引导你完成使用 Spring Boot 创建一个简单的应用程序，并添加数据库来存储信息的过程。

通过以下四个步骤，你将学习 Kotlin 语言的许多核心特性：
...
首先，使用 IntelliJ IDEA [创建一个使用 Kotlin 的 Spring Boot 项目](jvm-create-project-with-spring-boot.md)。
...
* ![Slack](slack.svg){width=25}{type="joined"} **Kotlin Slack**：[获取邀请](https://surveys.jetbrains.com/s3/kotlin-slack-sign-up)并加入 [#spring](https://kotlinlang.slack.com/archives/C0B8ZTWE4) 与 [#server](https://kotlinlang.slack.com/archives/C0B8RC352) 频道
...
* ![YouTube](youtube.svg){width=25}{type="joined"} **Kotlin YouTube 频道**：订阅并观看 [Kotlin 与 Spring](https://www.youtube.com/playlist?list=PLlFc5cFwUnmxOJL0GSSZ1Vot4KL2Vwe7x) 相关的视频