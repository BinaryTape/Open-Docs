...
## 为 Advent of Code 做好准备 {id="get-ready-for-advent-of-code"}
...
### 第 1 天：卡路里计数 (Calorie counting) {id="day-1-calorie-counting"}
...
### 第 2 天：石头剪刀布 (Rock paper scissors) {id="day-2-rock-paper-scissors"}
...
### 第 3 天：背包重整 (Rucksack reorganization) {id="day-3-rucksack-reorganization"}
...
### 第 4 天：营地清理 (Camp cleanup) {id="day-4-camp-cleanup"}
...
### 第 5 天：供应堆栈 (Supply stacks) {id="day-5-supply-stacks"}
...
### 第 6 天：调谐麻烦 (Tuning trouble) {id="day-6-tuning-trouble"}
...
### 第 7 天：设备上没有剩余空间 (No space left on device) {id="day-7-no-space-left-on-device"}
...
### 第 8 天：树顶树屋 (Treetop tree house) {id="day-8-treetop-tree-house"}
...
### 第 9 天：绳桥 (Rope bridge) {id="day-9-rope-bridge"}
...
### 第 10 天：阴极射线管 (Cathode-ray tube) {id="day-10-cathode-ray-tube"}
...
### 第 11 天：中间的猴子 (Monkey in the middle) {id="day-11-monkey-in-the-middle"}
...
### 第 12 天：爬山算法 (Hill Climbing algorithm) {id="day-12-hill-climbing-algorithm"}
...
### 第 1 天：声呐扫描 (Sonar sweep) {id="day-1-sonar-sweep"}
...
### 第 3 天：二进制诊断 (Binary diagnostic) {id="day-3-binary-diagnostic"}
...
### 第 4 天：巨型乌贼 (Giant squid) {id="day-4-giant-squid"}
...
### 第 1 天：报告修复 (Report repair) {id="day-1-report-repair"}
...
### 第 2 天：密码哲学 (Password philosophy) {id="day-2-password-philosophy"}
...
### 第 3 天：雪橇轨迹 (Toboggan trajectory) {id="day-3-toboggan-trajectory"}
...
### 第 4 天：护照处理 (Passport processing) {id="day-4-passport-processing"}
...
### 第 5 天：二进制登机 (Binary boarding) {id="day-5-binary-boarding"}
...
### 第 6 天：定制海关 (Custom customs) {id="day-6-custom-customs"}
...
### 第 7 天：便利提篮 (Handy haversacks) {id="day-7-handy-haversacks"}
...
### 第 8 天：手持设备停机 (Handheld halting) {id="day-8-handheld-halting"}
...
### 第 9 天：编码错误 (Encoding error) {id="day-9-encoding-error"}
