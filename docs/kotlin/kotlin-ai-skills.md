...
## 支持的工作流 {id="supported-workflows"}

您可以将 Kotlin AI 技能用于不同的 Kotlin 特定场景。以下示例展示了 AI 技能可以帮助您完成的一些任务。

### 将 Java 源文件转换为 Kotlin {id="convert-java-source-files-to-kotlin"}
...
### 将包含 Android 应用的多平台项目迁移到 AGP 9 {id="migrate-multiplatform-projects-with-android-apps-to-use-agp-9"}
...
### 将多平台项目从 CocoaPods 迁移到 SwiftPM 依赖项 {id="migrate-multiplatform-projects-from-cocoapods-to-swiftpm-dependencies"}
