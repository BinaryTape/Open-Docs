import{_ as a,c as i,o as n,ag as l}from"./chunks/framework.Bksy39di.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"ja/sqldelight/common/index_gradle_database.md","filePath":"ja/sqldelight/common/index_gradle_database.md","lastUpdated":1748443437000}'),p={name:"ja/sqldelight/common/index_gradle_database.md"};function t(e,s,h,k,E,d){return n(),i("div",null,s[0]||(s[0]=[l(`<p>まずプロジェクトにGradleプラグインを適用してください。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-WCE9G" id="tab-RkGuL_l" checked><label data-title="Kotlin" for="tab-RkGuL_l">Kotlin</label><input type="radio" name="group-WCE9G" id="tab-oH7KwRV"><label data-title="Groovy" for="tab-oH7KwRV">Groovy</label></div><div class="blocks"><div class="language-kotlin vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">kotlin</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">plugins</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
