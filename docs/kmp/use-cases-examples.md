...
## 按业务类型和团队划分的 Kotlin Multiplatform 用例 {id="kotlin-multiplatform-use-cases-by-the-type-of-business-and-team"}

以下是不同团队应用 Kotlin Multiplatform 以满足各种项目需求的几种方式：

### 启动全新项目（Greenfield Project）的初创公司 {id="startups-starting-a-new-greenfield-project"}
...
### 中小型企业 {id="small-and-medium-sized-businesses"}
...
### 需要跨设备应用行为一致的企业 {id="enterprises-that-need-consistent-behavior-across-devices-for-their-applications"}
...
### 拓展新市场的公司 {id="companies-expanding-to-new-markets"}
...
### 开发软件开发工具包 (SDK) 的团队 {id="teams-developing-software-development-kits-sdk"}
...
### 项目管理与生产力 {id="project-management-and-productivity"}
...
### 交通与出行 {id="transportation-and-mobility"}
...
### 教育科技 {id="educational-technology"}
...
### 社交网络与社区 {id="social-networking-and-community"}
