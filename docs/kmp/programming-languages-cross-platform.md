...
如今，您可能已经开始越来越频繁地注意到 [跨平台开发](cross-platform-mobile-development.md) 这一术语。事实上，在软件开发领域，跨平台编程正变得日益流行。它在移动应用领域尤其盛行，但其用途绝不仅限于这些类型的应用程序。随着企业努力通过多种设备和操作系统触达更广泛的受众，开发者们正转向能够消除平台壁垒的多功能语言和框架。
